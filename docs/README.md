...
| 文档 | 用途 |
|------|------|
| [../README.md](../README.md) | 产品门面、开发与发布 |
| [../CHANGELOG.md](../CHANGELOG.md) | 用户可见变更 |
| [../DESIGN.md](../DESIGN.md) | 设计入口（产品 overlay；品牌层在 kai-brand-design） |
| [ARCHITECTURE.md](./ARCHITECTURE.md) | 模块边界、播放/资料库契约、架构图 |
| [ROADMAP.md](./ROADMAP.md) | 能力地图与开放工作 |
| [AUDIO_FORMAT_MATRIX.md](./AUDIO_FORMAT_MATRIX.md) | 音频格式平台矩阵 |
